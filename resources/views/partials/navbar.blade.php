<link rel="shortcut icon" type="image/icon" href="/img/asyer.png"/>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
      <a class="navbar-brand h3" href="/">
        <img src="img/asyer.bmp" alt="" srcset="" width="30" height="30"  class="h3 ">
        Asyer Music Course Medan</a>
      ...
      <div class="collapse navbar-collapse h5" id="navbarNav">
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <a href="/login" class="nav-link js-scroll-trigger"><i class="bi bi-box-arrow-in-right red"></i> Login</a>
            </li>
          </ul>
      </div>
    </div>
